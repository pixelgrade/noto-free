<div class="wave-svg-mask">
  <svg class="wave-svg" width="18px" height="8px" viewBox="0 0 18 8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
      <pattern id="wavePattern<?php the_ID(); ?>" width="16" height="8" patternUnits="userSpaceOnUse" fill="none">
    ...
    <rect x="-10000" class="rect-anchor-50-50" width="20000" height="8" style="fill: url(#wavePattern<?php the_ID(); ?>);" />
  </svg>
</div>
