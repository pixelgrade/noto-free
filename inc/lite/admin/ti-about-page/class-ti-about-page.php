 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Noto_Lite_About_Page' ) ) {
	/**
	 * Singleton class used for generating the about page of the theme.
	 */
	class Noto_Lite_About_Page {
		/**
		 ...
		 *
		 * @var Noto_Lite_About_Page $instance The  TI_About_Page instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Noto_Lite_About_Page ) ) {
				self::$instance = new Noto_Lite_About_Page;
