...
function (_BaseComponent) {
  ...
  _createClass(NotoHeader, [{
    ...
    value: function bindEvents() {
      ...
      _components_base_ts_services_window_service__WEBPACK_IMPORTED_MODULE_4__["WindowService"].onScroll().takeWhile(function () {
        return _this2.subscriptionActive;
      }).subscribe(function () {
        _this2.latestScroll = window.scrollY;
      });
      _components_base_ts_services_window_service__WEBPACK_IMPORTED_MODULE_4__["WindowService"].onResize().takeWhile(function () {
        return _this2.subscriptionActive;
...
function (_BaseTheme) {
  ...
  _createClass(Noto, [{
    ...
    value: function adjustLayout() {
      ...
      cq.reevaluate(false, function () {// Do something after all elements were updated
      });
    }
  }]);
